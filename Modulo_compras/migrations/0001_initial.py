...
# Generated by Django 3.2.9 on 2022-02-24 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Modulo_compras.tipo_producto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True, verbose_name='estado')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Modulo_compras.producto')),
            ],
            options={
                'verbose_name': 'Compra',
