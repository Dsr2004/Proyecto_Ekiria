# Generated by Django 3.2.7 on 2022-01-20 23:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.IntegerField()),
                ('municipio', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ModuloUsuarios.municipio')),
                ('rol', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ModuloUsuarios.rol')),
                ('tipo_documento', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ModuloUsuarios.tipodocumento')),
            ],
            options={
